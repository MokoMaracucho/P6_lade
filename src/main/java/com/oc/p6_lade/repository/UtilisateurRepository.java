...
public interface UtilisateurRepository extends JpaRepository<Utilisateur, Long> {
    ...
    @Query(value="UPDATE utilisateur u SET u.prenom_utilisateur = :prenomUtilisateur WHERE u.id_utilisateur = :idUtilisateur", nativeQuery=true)
    int majPrenomUtilisateur(@Param("idUtilisateur") Long idUtilisateur, @Param("prenomUtilisateur") String prenomUtilisateur);

    @Modifying(clearAutomatically=true)
    @Query(value="UPDATE utilisateur u SET u.nom_utilisateur = :nomUtilisateur WHERE u.id_utilisateur = :idUtilisateur", nativeQuery=true)
    int majNomUtilisateur(@Param("idUtilisateur") Long idUtilisateur, @Param("nomUtilisateur") String nomUtilisateur);

    @Modifying(clearAutomatically=true)
    @Query(value="UPDATE utilisateur u SET u.email_utilisateur = :emailUtilisateur WHERE u.id_utilisateur = :idUtilisateur", nativeQuery=true)
    int majEmailUtilisateur(@Param("idUtilisateur") Long idUtilisateur, @Param("emailUtilisateur") String emailUtilisateur);

    @Modifying(clearAutomatically=true)
    @Query(value="UPDATE utilisateur u SET u.privilege_utilisateur = :majPrivilegeUtilisateur WHERE u.id_utilisateur = :idUtilisateur", nativeQuery=true)
